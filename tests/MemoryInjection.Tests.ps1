...
Describe 'Claude Cowork UserPromptSubmit required-memory injection' {
    BeforeAll {
    ...
    BeforeEach {
        ...
        $env:MCP_PLUGIN_HOST = 'claude-cowork'
        $env:MCP_CACHE_DIR_OVERRIDE = $script:TestRoot
        $env:MCP_AGENT_NAME = 'ClaudeCowork'
...
sessionId: ClaudeCowork-20260714T000000Z-plugin-session
agent: ClaudeCowork
status: verified
